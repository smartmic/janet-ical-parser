...
(defn schedule-set-from-ics-string
  "Convert and consolidate iCalendar text to a Janet schedule table"
  [ics-string & jip-conf]
  (schedule-set (table-from-ics-string ics-string ;jip-conf)))

(defn schedule-set-from-ics-file
  "Convert and consolidate iCalendar text to a Janet schedule table"
  [ics-file-path & jip-conf]
  (schedule-set (table-from-ics-file ics-file-path ;jip-conf)))
